...
BasicGame.Game.prototype = {
  ...
  create: function() {
    ...
    this.scoreText = this.add.text(600, 510, 'Acorns: 500');
    ...
    this.guessText = this.add.text(400, 510, 'Guess: 1');
    ...
    this.realText = this.add.text(200, 510, 'Real Value: ???');
    ...
    this.m10 = this.add.sprite(150, 150, 'acorn');
    this.m11 = this.add.sprite(150, 150, 'acorn');
    this.m12 = this.add.sprite(150, 150, 'acorn');
    this.m13 = this.add.sprite(150, 150, 'acorn');
    this.m14 = this.add.sprite(150, 150, 'acorn');
    this.m15 = this.add.sprite(150, 150, 'acorn');
    this.m16 = this.add.sprite(150, 150, 'acorn');
    this.m17 = this.add.sprite(150, 150, 'acorn');
    this.m18 = this.add.sprite(150, 150, 'acorn');
    this.m19 = this.add.sprite(150, 150, 'acorn');

    this.m20 = this.add.sprite(150, 150, 'acorn');
    this.m21 = this.add.sprite(150, 150, 'acorn');
    this.m22 = this.add.sprite(150, 150, 'acorn');
    this.m23 = this.add.sprite(150, 150, 'acorn');
    this.m24 = this.add.sprite(150, 150, 'acorn');
    this.m25 = this.add.sprite(150, 150, 'acorn');
    this.m26 = this.add.sprite(150, 150, 'acorn');
    this.m27 = this.add.sprite(150, 150, 'acorn');
    this.m28 = this.add.sprite(150, 150, 'acorn');
    this.m29 = this.add.sprite(150, 150, 'acorn');
    ...
    this.s0 = this.add.sprite(300, 300, 's1');
    this.s1 = this.add.sprite(300, 300, 's2');
    this.s2 = this.add.sprite(300, 300, 's3');
    this.s3 = this.add.sprite(300, 300, 's4');
    this.s4 = this.add.sprite(300, 300, 's5');
    this.s5 = this.add.sprite(300, 300, 's1');
    this.s6 = this.add.sprite(300, 300, 's2');
    this.s7 = this.add.sprite(300, 300, 's3');
    this.s8 = this.add.sprite(300, 300, 's4');
    this.s9 = this.add.sprite(300, 300, 's5');
  ...
  gameWin: function() {
    ...
    var gw = this.add.sprite(-75, 0, 'gameWin');
    gw.alpha = 0;
    this.timer.alpha = 0;
