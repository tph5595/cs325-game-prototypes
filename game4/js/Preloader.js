...
BasicGame.Preloader.prototype = {
  ...
  preload: function() {
    ...
    this.load.image('player-red', 'assets/paddle.png');

    this.load.image('enemy', 'assets/ice2.png');

    this.load.image('sun1', 'assets/sun1.png');
    this.load.image('sun2', 'assets/sun2.png');
    this.load.image('sun3', 'assets/sun3.png');
    this.load.image('sun4', 'assets/sun4.png');

    this.load.image('bar1', 'assets/bar1.png');
